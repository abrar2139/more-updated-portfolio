...
export const Footercomponent = () => {
  return (
   ...
   <p className='flex text-2xl p-1'> <a  href='https://github.com/abrar2139' target='_blank' rel="noopener noreferrer"><FaGithub  className='mr-5 cursor-pointer hover:text-black'/></a><a href='https://www.linkedin.com/in/muhammad-abrar-ahmad ' target='_blank' rel="noopener noreferrer"><FaLinkedin className='cursor-pointer hover:text-black'/></a></p>
  </footer>
  </>
  )
}
